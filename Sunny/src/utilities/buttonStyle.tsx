export const buttonStyle = (buttonType?: string) => {
  if (buttonType === "confirm") {
    ...
    return "bg-blue-400 hover:bg-blue-300 transition-all ease-out duration-200 hover:drop-shadow-md  active:outline-double text-black font-bold py-2 px-4 mx-2 rounded";
