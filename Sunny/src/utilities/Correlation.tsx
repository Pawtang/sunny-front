...
// Moved this out but it was fine where it was.
...
export const Correlation = (days: Array<dayObject>, attrs: Array<attributeObject) => {
  ...
  days.forEach((day, dayCount) => {
    ...
    day.attributes && day.attributes.forEach((attr) => {
